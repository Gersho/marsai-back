...
const createMovie = async (newMovie: MovieRequest): Promise<number| null> => {
    ...
    sql,
    [newMovie.originalTitle, newMovie.englishTitle, newMovie.youtubeUrl, newMovie.coverImage, newMovie.duration, newMovie.isHybrid, newMovie.language, newMovie.originalSynopsis, newMovie.englishSynopsis, newMovie.creativeProcess, newMovie.iaTools, newMovie.hasSubs, newMovie.srt, newMovie.status],
  );
